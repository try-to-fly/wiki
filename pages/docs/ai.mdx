...
1. [chatGpt](./chatGPT.mdx)：翻译、润色写作、编码、QA。<Badge rate={5} />
...
3. Adobe Firefly（通过 PhotoShop 使用）
4. OpenAI DALLE-2
5. OpenJourney
...
1.  [Whisper model](https://openai.com/research/whisper)：openai 开源的模型
    - [Awesome-whisper](https://github.com/sindresorhus/awesome-whisper): 收录了各种 whisper 的内容。<Badge github="https://github.com/sindresorhus/awesome-whisper" />
...
1. [bark](https://huggingface.co/spaces/suno/bark): 通用文本到音频模型。<Badge github="https://github.com/suno-ai/bark" />
...
- [AI 中转站服务状态查询](./ai/relay-status.mdx)：聚合一些第三方状态页入口。
