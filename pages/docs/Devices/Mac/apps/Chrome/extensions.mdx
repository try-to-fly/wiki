...
3. [Tampermonkey](./extensions/tampermonkey.mdx)：油猴子
...
1. [immersive-translate](https://immersive-translate.owenyoung.com/)：沉浸式双语网页翻译扩展,比 chrome 内置的翻译好用。支持 chatGPT，以及谷歌、百度等 10 多种翻译服务。<Badge github="https://github.com/immersive-translate/immersive-translate" />
